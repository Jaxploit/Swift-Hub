...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Slap Battles | Swift-Hub"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Made by Nyron"
	if Settings.LoadingTitle ~= "Slap Battles | Swift-Hub" then
		LoadingFrame.Version.Text = "Swift-Hub"
	end
